...
//   return (
//     <div className="position-fixed top-0 start-0 w-100 d-flex align-items-center justify-content-between px-4 py-3 bg-black shadow-sm" style={{ zIndex: 1050 }}>
...
//         {!user ? (
//           <button onClick={openSignIn} className="btn btn-danger rounded-pill px-4">Login</button>
//         ) : (
//           <UserButton>
...
//                 onClick={() => navigate('/my-bookings')}   // ✅ navigate properly
//               />
//             </UserButton.MenuItems>
//           </UserButton>
//         )}
...
//           {favoriteMovies.length >0 && <Link to="/favorite" className="text-white text-decoration-none fw-medium" onClick={() => setOpen(false)}>Favorites</Link>}
//         </div>
//       </div>
//     </div>
//   )
